...
export const toolCategories: ToolCategory[] = [
  {
    slug: 'finance',
    name: 'Finance',
    description: 'Money tools for planning goals, comparing loans, tracking returns, handling GST, and solving everyday financial calculations.',
    metaDescription:
    ...
    homeSummary: 'Loans, investing, tax, pricing, and money-planning tools in one category.',
  },
  {
    ...
    homeSummary: 'Fast unit conversions across measurement, storage, speed, and temperature.',
  },
  {
    slug: 'text-tools',
    name: 'Text',
    ...
    homeSummary: 'Clean, format, sort, and transform text with minimal friction.',
  },
  {
    ...
    homeSummary: 'Technical utilities for inspecting and working with structured data.',
  },
  {
    slug: 'date-tools',
    name: 'Date',
    ...
    homeSummary: 'Age, duration, and date-gap tools for everyday date calculations.',
  },
  {
    slug: 'health-tools',
    name: 'Health',
    ...
    homeSummary: 'Health-related planning tools for quick timeline and due-date checks.',
  },
]

        ...
        <Stack spacing={{ xs: 3, md: 2.5 }}>
          <Box sx={{ maxWidth: 760 }}>
            ...
            <Typography color="text.secondary" sx={{ lineHeight: 1.8 }}>
              Calculate body mass index from your height and weight and check the
              standard BMI category instantly.
            </Typography>
          </Box>
                  ...
                  {result.bmi ? (
                    <>
                      <Stack spacing={0.75}>
                        ...
                        <Typography color="text.secondary">Body Mass Index</Typography>
                      </Stack>
                      ...
                      <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
                        BMI is a general screening measure and should not be treated as a
                        medical diagnosis on its own.
                      </Typography>
                    </>
                  ) : (
